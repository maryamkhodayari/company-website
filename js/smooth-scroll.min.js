  ...
  function (e) {
    ...
    var t = {
      ...
      l = function (t, n, o, r) {
        ...
        return (
          (a = Math.max(a - n - o, 0)),
          r && (a = Math.min(a, s() - e.innerHeight)),
          a
        );
      },
      d = function (e) {
    ...
    return function (a, p) {
            ...
            var y,
              ...
              w = c
                ...
                : l(
                    ...
                    E,
                    parseInt(
                      "function" == typeof i.offset ? i.offset(n, r) : i.offset,
                      10
                    ),
                    i.clip
                  ),
              ...
              q = function (t, o) {
                var a = e.pageYOffset;
                if (t == o || a == o || (v < o && e.innerHeight + a) >= A)
                  return (
                    I.cancelScroll(!0),
                    m(n, o, c),
                    h("scrollStop", i, n, r),
              ...
              Q = function (t) {
                y || (y = t),
                  (H += t - y),
                  (b = H / parseInt(i.speed, 10)),
                  (b = b > 1 ? 1 : b),
                  (C = v + L * u(i, b)),
                  e.scrollTo(0, Math.floor(C)),
                  q(C, w) || ((O = e.requestAnimationFrame(Q)), (y = t));
              };
      ...
      var C = function (t) {
          if (
            ...
            !t.ctrlKey &&
            "closest" in t.target &&
            (y = t.target.closest(a)) &&
            "a" === y.tagName.toLowerCase() &&
            !t.target.closest(g.ignore) &&
            y.hostname === e.location.hostname &&
            y.pathname === e.location.pathname &&
            /#/.test(y.href)
          ) {
            var n = c(i(y.hash)),
              o =
            ...
            (o = o || "#top" !== n ? o : document.documentElement),
              o && (t.preventDefault(), I.animateScroll(o, y));
          }
        },
        w = function (e) {
          if (
            ...
            t && I.animateScroll(t, null, { updateURL: !1 });
          }
        },
        L = function (e) {
          b ||
      ...
      return (
        ...
        (I.init = function (r) {
          ...
          I.destroy(),
            ...
            S && e.addEventListener("resize", L, !1),
            g.updateURL && g.popstate && e.addEventListener("popstate", w, !1);
        }),
        I.init(p),
        I
      );
